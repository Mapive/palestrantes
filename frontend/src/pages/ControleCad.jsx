...
export default function ControleCad({ getUsers, onEdit, setOnEdit }) {
  ...
  useEffect(() => {
    //--------verifica se o formulario possui algum item sde edição
    if (onEdit) {
          ...
          <Form ref={ref} onSubmit={handleSubmit}>
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Control
                name="position"
                type="text"
                placeholder="Insira o cargo de atuação"
                required
              />
            </Form.Group>
            <Form.Group className="mb-3">
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Control
                name="linkedin"
                type="url"
                placeholder="Insira o link para o LinkedIn"
              />
            </Form.Group>
            <center>
              <Button
